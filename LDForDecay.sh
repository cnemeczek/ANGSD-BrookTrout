...
#-----------------------------------------------
#Script to compute LD on all 2.6million SNPs
#to determine max_kb_dist for ld prunning.
#-----------------------------------------------
...
--probs \
--n_ind 192 \
--n_sites 2620282 \ #numbers of SNPs in AllStreams_SamTools_GLfromSNPList.mafs.gz
--max_kb_dist 100 \
--out $OUTPUT/'AllStreams_maxkb100_fordecay.ld'
